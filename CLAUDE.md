...
- Próximo MVP recomendado: rodada de testes dos engenheiros; depois Extend/Fillet de spline e grips de edição, edição de texto no canvas (duplo clique) ou seguir o roadmap para blocos e importação DXF.
