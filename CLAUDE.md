...
- Próximo MVP recomendado: rodada de testes dos engenheiros; depois grips das demais entidades, edição de texto no canvas (duplo clique) ou seguir o roadmap para blocos e importação DXF.
