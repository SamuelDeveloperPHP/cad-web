...
- Próximo MVP recomendado: edição de texto no canvas (duplo clique) e estilos de texto nomeados, ou seguir o roadmap para blocos e importação DXF.
