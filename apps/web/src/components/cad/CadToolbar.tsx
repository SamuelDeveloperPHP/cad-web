import { Circle, Copy, CornerDownRight, CornerRightDown, Eraser, Grid3X3, Hand, Minus, MousePointer2, Move, MoveRight, RotateCw, Scaling, Scissors, Square } from "lucide-react";
